...
- **[5.5.1 — Deploy Endpoint](5.5.1-endpoint-deployment/)**: đóng gói model, deploy lên SageMaker Endpoint, 3 lỗi thực tế đã sửa, và validate độ chính xác bằng dữ liệu lịch sử thật.
- **[5.5.2 — Serverless API & Demo UI](5.5.2-serverless-api-ui/)**: expose endpoint qua Lambda + API Gateway, kiểm thử toàn trình, và demo dashboard chạy local cho trình bày/thuyết trình.
