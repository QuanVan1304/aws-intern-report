...
- **[5.5.1 — Endpoint Deployment](1-endpoint-deployment/)**: packaging the model, deploying to a SageMaker Endpoint, the three real bugs fixed along the way, and validating accuracy against real historical data.
- **[5.5.2 — Serverless API & Demo UI](2-serverless-api-ui/)**: exposing the endpoint through Lambda + API Gateway, end-to-end testing, and a local demo dashboard for presentations.
