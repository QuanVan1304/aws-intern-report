...
```
Tập dữ liệu gốc từ Kaggle được lưu trữ nguyên vẹn tại thư mục `raw/`:
![Thư mục gốc của dự án](/images/5-Workshop/5.3-Data-preprocessing/5.png)
...
Các tệp kết quả từ kịch bản tiền xử lý (`train.csv`, `val.csv`, `test.csv`, `scaler.pkl`) được đẩy lên thư mục `processed/`, chuẩn bị sẵn sàng cho giai đoạn huấn luyện:
![Dữ liệu Processed trên S3](/images/5-Workshop/5.3-Data-preprocessing/3.png)
...
```
Sau khi thực thi các lệnh trên, tài nguyên được tổ chức theo cấu trúc phân tầng trên Amazon S3. Thư mục dự án bao gồm các phân vùng riêng biệt cho dữ liệu, mô hình và mã nguồn:

![Thư mục gốc của dự án](/images/5-Workshop/5.3-Data-preprocessing/1.png)

Bên trong nhánh dữ liệu, các tệp được phân tách thành hai trạng thái trước và sau khi xử lý:

![Thư mục chứa nhánh dữ liệu](/images/5-Workshop/5.3-Data-preprocessing/2.png)
